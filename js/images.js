const IMAGES = {
  ...
  CHICKEN: {
    ...
    DEAD: ['./img/3.Secuencias_Enemy_basico/Version_Gallinita/4.G_muerte.png'],
  },
  CHICK: {
    WALKING: [
    ...
    DEAD: ['./img/3.Secuencias_Enemy_basico/Version_pollito/4.Muerte.png'],
  },
  ENDBOSS: {
    WALKING: [
  ...
  COINS: ['./img/8.Coin/Moneda1.png', './img/8.Coin/Moneda2.png'],
  BOTTLES: {
    GROUND: ['./img/6.botella/2.Botella_enterrada1.png', './img/6.botella/2.Botella_enterrada2.png'],
    THROWN: {
      ROTATING: [
